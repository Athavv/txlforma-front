...
import MaScene3D from "../../assets/3D/Exportsalledecours.glb";
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 px-5">
          <div className="md:col-span-7 p-6">
            <p className="mt-0 md:mt-8 text-justify text-lg">
              Découvrez un environnement conçu pour la réussite. Nos salles de classe ne sont pas de simples pièces,
              mais des écosystèmes technologiques pensés pour favoriser l'interaction, la concentration et la créativité.
              Grâce à notre modélisation 3D, explorez chaque détail de l'équipement mis à votre disposition.
            </p>
            <p className="mt-7 text-justify text-lg">
              Au-delà de l'esthétique, notre approche repose sur la synergie entre l'humain et son espace de travail.
              Nous croyons que la qualité des finitions — du grain satiné du mobilier à la clarté du système acoustique —
              influence directement la capacité d'assimilation et le bien-être des apprenants. Chaque élément modélisé
              ici reflète notre engagement : offrir un cadre professionnel, épuré et hautement technologique.
            </p>
          </div>
          <div className="md:col-span-5 pd-3 md:p-6">
            <img src={quisommesnous} alt="Aperçu salle" className="h-auto mx-auto rounded-xl shadow-md" />
          </div>
        </div>
      </div>
