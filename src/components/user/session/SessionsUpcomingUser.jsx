...
export default function SessionsUpcomingUser({ sessions }) {
  ...
  const sortedSessions = [...sessions].sort(
    (sessionA, sessionB) =>
      new Date(sessionA.startDate) - new Date(sessionB.startDate)
  );
          ...
          <div className="col-span-12 lg:col-span-7 p-8 flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-2xl font-medium text-noir mb-2">
                {session.formationTitle || session.formation?.title}
              </h3>
              ...
              <div className="mb-3 flex items-center gap-2 py-2 w-fit">
