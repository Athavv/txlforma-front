    ...
    <div className="mx-auto space-y-6">
      <div>
        ...
        <p className="text-gray-700 mb-6 w-full">
          Modifiez les informations de l'utilisateur. Vous pouvez changer le
          nom, l'email et le rôle. Si vous souhaitez changer le mot de passe,
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex justify-start">
                <button
                  type="submit"
                  disabled={loading}
                  className="w-2/5 px-6 py-3 bg-noir text-blanc rounded-2xl hover:bg-violet font-medium transition-colors"
                >
