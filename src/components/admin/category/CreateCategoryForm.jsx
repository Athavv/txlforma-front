    ...
    <div className="mx-auto space-y-6">
      <div>
        ...
        <p className="text-gray-700 mb-6 w-full">
          Cette section vous permet d'ajouter une nouvelle catégorie à la
          plateforme. Renseignez ses informations de base (nom, description,
          image) afin qu'elle puisse être utilisée pour organiser les
          formations.
        </p>
      </div>
      ...
      <div className="grid grid-cols-12 gap-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex justify-start">
                <button
                  ...
                  className="w-2/5 px-6 py-3 bg-noir text-blanc rounded-xl hover:bg-violet font-regular"
                >
                  {loading ? "Création..." : "Créer une catégorie +"}
                </button>
              </div>
            </form>
          </div>
        ...
        <div className="col-span-12 md:col-span-5 p-4 hidden md:block -mt-24">
          {animationData && (
            <Lottie
